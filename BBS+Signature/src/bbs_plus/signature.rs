...
//            println!("Hashed M {}", m.tostring());
        ...
        A = pair::g1mul(&A, &ex); // Exponential operation corresponds to elliptic curve multiplication
...
impl BBSPlusSig {
    pub fn verify(&self, messages: Vec<&str>, pk: &BBSPlusPublicKey, q: &BIG) -> bool {
       ...
       //ate pairing is divided into two steps: the main loop and the final power calculation
